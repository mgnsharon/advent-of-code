    ...
    >
      ...
      style="border-color: hsla(105, 69%, 30%, 50%)">
        ...
        <p class="mt-6 text-xl text-ctp-text max-w-3xl">
            ...
            <a class="text-red-400" href="https://github.com/mgnsharon/advent-of-code/tree/main/2023/rust">
              Rust
            </a>. This site is built with Leptos and Wasm.
        </p>
        <p class="mt-6 text-xl text-ctp-text max-w-3xl">
        <a class="text-ctp-blue" href="https://github.com/mgnsharon/advent-of-code/tree/main/2023/rust">GitHub Repo</a>
        </p>
        </div>
